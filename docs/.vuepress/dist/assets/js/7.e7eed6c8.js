  ...
  [7],
  {
    ...
    220: function(t, n, s) {
      ...
      var o = {
          ...
          methods: {
            svgHtml: function() {
              return s(212)('./'.concat(this.name, '.svg'))
            }
          }
        },
        e = s(22),
        r = Object(e.a)(
          ...
          function() {
            var t = this,
              n = t.$createElement,
              s = t._self._c || n
            return s('span', { staticClass: 'gt-ico' }, [
              s('span', { staticClass: 'gt-svg', domProps: { innerHTML: t._s(t.svgHtml()) } }),
              t._v(' '),
              t.text ? s('span', { staticClass: 'gt-ico-text' }, [t._v(t._s(t.text))]) : t._e()
            ])
          },
          [],
          !1,
